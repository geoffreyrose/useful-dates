...
$usefulDate->addDate("Patrick Star's Birthday", Carbon::createFromFormat('Y-m-d', '1999-08-17'), startYear: 1999);
$usefulDate->addDate('April Fools Day', Carbon::createFromFormat('Y-m-d', '1582-04-01'), startYear: 1582);
